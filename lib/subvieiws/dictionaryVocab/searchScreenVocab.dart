...
import 'package:buddhadham/subvieiws/dictionaryVocab/screenForSearchVocab.dart';
...
class SearchScreenVocab extends StatefulWidget {
  @override
  _SearchScreenVocabState createState() => _SearchScreenVocabState();
}

class _SearchScreenVocabState extends State<SearchScreenVocab> {
  ...
  Future<void> _search(String query) async {
    ...
    List<String> allTexts = await sectionVocab.listAllText;
    List<String> searchResults = [];

    for (int i = 0; i < allTexts.length; i++) {
      final rawData = allTexts[i];
      String data = allTexts[i].replaceAll(RegExp(r'<[^>]*>'), ' ');
                          ...
                          onTap: () async {
                            ...
                            if (pageIndex != -1) {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => ReadScreenForSearchVocab(
