...
class ReadScreenVocab extends StatefulWidget {
  final int initialPage;
  const ReadScreenVocab({Key? key, required this.initialPage})
      : super(key: key);

  @override
  State<ReadScreenVocab> createState() => _ReadScreenVocabState();
}

class _ReadScreenVocabState extends State<ReadScreenVocab> {
