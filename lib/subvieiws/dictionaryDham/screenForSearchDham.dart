import 'package:buddhadham/models/SectionDham.dart';
...
class ReadScreenForSearchDham extends StatefulWidget {
  final int initialPage;
  final String searchText;
  const ReadScreenForSearchDham({Key? key, required this.initialPage, required this.searchText}) : super(key: key);

  @override
  State<ReadScreenForSearchDham> createState() => _ReadScreenForSearchDhamState();
}

class _ReadScreenForSearchDhamState extends State<ReadScreenForSearchDham> {
  ...
  Future<List<String>>? getData() async {
    try {
      List<String>? listData = await SectionDham.listAllText;
      setState(() {
