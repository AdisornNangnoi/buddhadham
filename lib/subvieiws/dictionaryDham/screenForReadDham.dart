...
class ReadScreenDham extends StatefulWidget {
  final int initialPage;
  const ReadScreenDham({Key? key, required this.initialPage}) : super(key: key);

  @override
  State<ReadScreenDham> createState() => _ReadScreenDhamState();
}

class _ReadScreenDhamState extends State<ReadScreenDham> {
