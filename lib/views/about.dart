          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                TextButton(
                  onPressed: () {
                    _launchInBrowser(Uri.parse('https://buddhadhamma.com/buddhadhamma_sau_permissionletter.pdf'));
                  },
                  child: Text(
                    'จดหมายได้รับการอนุญาตในการพัฒนาแอปพลิเคชัน\nพุทธธรรมฉบับดิจิตอล\nจากท่านสมเด็จพระพุทธโฆษาจารย์\nพระพรหมคุณากรณ์\n(ป. อ. ปยุตฺโต)\n',
                    style: GoogleFonts.sarabun(
                      textStyle: TextStyle(
                ...
                TextButton(
                  ...
                  child: Text(
                    'www.sau.ac.th',
                    style: GoogleFonts.sarabun(
                      textStyle: TextStyle(fontSize: SizerUtil.deviceType == DeviceType.mobile ? AppTextSetting.APP_FONTSIZE_READ : AppTextSetting.APP_FONTSIZE_READ_TABLET, fontStyle: FontStyle.italic),
                    ),
                  ),
                ),
                Text(
